  ...
  return (
    <section className="pt-36 pb-16 px-4">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-row flex-nowrap justify-center gap-4 max-w-full mx-auto mb-8 overflow-x-auto">
          <div className="flex items-center justify-center gap-2 text-white/40 text-xs sm:text-sm whitespace-nowrap">
