...
export default function Navbar({ session, isAdmin, onOpenAuth, onLogout }: NavbarProps) {
  ...
  return (
    <>
    <div className="fixed top-16 left-0 right-0 z-40 bg-emerald-500 text-white text-center py-3 px-4 shadow-lg shadow-emerald-500/30">
      <p className="font-bold text-sm sm:text-base leading-tight">
        🎁 FREE PLAN &nbsp;·&nbsp; Temporary free phase: 15 videos per day — no credit card needed
      </p>
    </div>
